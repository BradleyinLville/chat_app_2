...
class ListofMessagesforOneChat {
  List<ListOfMessages> masterChatList;
  List<ListOfMessages> oneChatMessageList(
      List<List<ListOfMessages>> masterChatList, int index) {
    return masterChatList[index];
  }

  ListofMessagesforOneChat();
}

class ListOfChats {
  ListOfMessages listOfMessages;

  List<ListOfMessages> messagesByChatID(ListOfMessages listOfMessages) {
    List<ListOfMessages> eachChatInList;
